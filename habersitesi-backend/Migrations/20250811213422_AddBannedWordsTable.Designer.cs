...
namespace habersitesi_backend.Migrations
{
    ...
    [Migration("20250811213422_AddBannedWordsTable")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("habersitesi_backend.Models.BannedWord", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("habersitesi_backend.Models.Comment", b =>
                {
                    ...
                    b.HasIndex("NewsId", "ParentId", "Approved")
            ...
            modelBuilder.Entity("habersitesi_backend.Models.RelatedNews", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
                    ...
                    b.HasIndex("NewsId", "SimilarityScore")
            ...
            modelBuilder.Entity("habersitesi_backend.Models.User", b =>
                {
                    ...
                    b.Property<DateTime?>("LastGoogleLogin")
                        .HasColumnType("timestamp with time zone");
            ...
            modelBuilder.Entity("habersitesi_backend.Models.Comment", b =>
                {
                    ...
                    b.HasOne("habersitesi_backend.Models.Comment", "Parent")
                        .WithMany("Replies")
            ...
            modelBuilder.Entity("habersitesi_backend.Models.News", b =>
                {
                    b.HasOne("habersitesi_backend.Models.User", "ApprovedBy")
                        .WithMany()
                        .HasForeignKey("ApprovedByUserId")
                        .OnDelete(DeleteBehavior.Restrict);

                    b.HasOne("habersitesi_backend.Models.Category", "CategoryRef")
                        .WithMany("News")
            ...
            modelBuilder.Entity("habersitesi_backend.Models.RelatedNews", b =>
                {
                    ...
                    b.HasOne("habersitesi_backend.Models.News", "RelatedNewsItem")
                        .WithMany()
